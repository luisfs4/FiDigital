<div class="container-fluid pt-2 pb-4">
    <div class="row">
        ...
        <div class="btn btn-warning ms-auto me-4 w-auto text-white bg-gradient-danger nuevo_programa">
            <div class="text-white">
                Nuevo programa&nbsp;&nbsp;<div class="fa fa-plus-circle"></div>
            </div>
        </div>
        ...
        <div class="col-xxl-12 col-xl-12 order-xxl-0 col-12">
            <div class="card">
                <div class="card-header p-3">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="mb-0">Programas</h6>
                        </div>
                        <div class="col-md-6 d-flex justify-content-end align-items-center">
                            <small>Filtrando todos los programas</small>
                        </div>
                    </div>
                    <hr class="horizontal dark mb-0">
                </div>
                <div class="card-body p-3 pt-0">
                    <table class="table align-items-center justify-content-center mb-0 tabla_programas">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ult actualización</th>
