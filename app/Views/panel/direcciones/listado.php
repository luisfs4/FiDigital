<div class="container-fluid pt-2 pb-4">
    <div class="row">
        ...
        <div class="btn btn-warning ms-auto me-4 w-auto text-white bg-gradient-danger btn_nueva_direccion">
            <div class="text-white">
                Nueva dirección&nbsp;&nbsp;<div class="fa fa-plus-circle"></div>
            </div>
        </div>
                ...
                <div class="card-header p-3">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end align-items-center">
                            <small>Filtrando todas los direcciones</small>
                        </div>
                    </div>
                    <hr class="horizontal dark mb-0">
                </div>
                <div class="card-body p-3 pt-0">
                    <table class="table align-items-center justify-content-center mb-0 tabla_direcciones">
                        <thead>
                            <tr>
