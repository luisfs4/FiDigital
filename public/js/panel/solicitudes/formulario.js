...
const crear_expediente = () => {
    ...
    let datos_expediente = $('.multisteps-form__panel form').parsley().validate();
    
    console.log(datos_expediente);
    ...
    if (datos_expediente) {
        ...
        $('.input_solicitud').each(function (index, input) { //Buscar todos los inputs
        ...
        Swal.fire({
            title: "¿Deseas envíar la solicitud?",
            ...
            if (respuesta.value) {
                ...
                $.ajax({
                    url: '/FiDigital/panel/solicitudes/post_solicitud',
                    ...
                    success: function (respuesta) {
                        if (respuesta == true) {
                            Swal.fire({
                                title: 'Solicitud envíada con éxito',
                                ...
                                window.location.href = '/FiDigital/panel/solicitudes/';
                            })
                        } else {
