...
const crear_sesion = async (json_editar = []) => {
    ...
    Swal.fire({ //Crar una sesión nueva
        ...
        <form class="w-100 m-auto row p-2 text-start form_sesion" data-validate="parsley">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <textarea required name="observaciones" class="input_sesion form-control input-lg p-2" placeholder="Describe tus observaciones..."></textarea>
                </div>
            </div>
        </form>
        `,
        ...
        if (result.isConfirmed) { //Validar clic en boton de aceptar
            await $.ajax({
                url: '/panel/expedientes/sesiones/post_sesion',
                data: {
